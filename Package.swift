...
let package = Package(
    name: "WhatsX",
    platforms: [
        // iOS 16 floor so the package loads in Swift Playgrounds on iPad.
        // Native Liquid Glass adopts automatically at runtime on iOS 26 —
        // see Sources/Design/Glass.swift for the availability-gated helpers.
        .iOS(.v16)
    ],
    products: [
